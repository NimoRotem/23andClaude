"""
Test registry — all genomic tests parsed from the master checklist.
Each test has: id, category, name, description, test_type, params.

test_type determines which runner handles it:
  - variant_lookup: query specific rs numbers from VCF
  - vcf_stats: run bcftools/samtools stats
  - pgs_score: download PGS Catalog scoring file, run plink2 --score
  - clinvar_screen: filter VCF against ClinVar for gene panel
  - specialized: custom pipeline (ancestry PCA, PGx, etc.)
"""
...
_t("qc_titv", "Sample QC", "Ti/Tv ratio",
   "Transition/transversion ratio. WGS: 2.0-2.1",
...
_t("pgs_longevity_906", "PGS - Lifestyle", "Longevity (PGS000906)",
   "330 variants. HR 0.89/SD. Tesi N et al., J Gerontol 2021",
...
# ── Expanded from checklist.md (auto-generated) ─────────────────
# PGS - Autoimmune
...
_t("pgs_psoriasis_1288", "PGS - Autoimmune", "Psoriasis (PGS001288)",
   "7,534 variants. AUROC 0.70. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001288", "trait": "Psoriasis"})
...
_t("pgs_ankylosing_1289", "PGS - Autoimmune", "Ankylosing spondylitis (PGS001289)",
   "2,874 variants. AUROC 0.85. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001289", "trait": "Ankylosing spondylitis"})
...
_t("pgs_vitiligo_1290", "PGS - Autoimmune", "Vitiligo (PGS001290)",
   "3,672 variants. AUROC 0.72. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001290", "trait": "Vitiligo"})
...
_t("pgs_breast_5349", "PGS - Cancer", "Breast cancer (PGS005349)",
   "5,438,842 variants. AUROC 0.647, C-index 0.66. Tanha HM et al., EJHG 2026. (Multi (SBayesRC))",
...
_t("pgs_prostate_5241", "PGS - Cancer", "Prostate cancer (PGS005241)",
   "3,800,000 variants. AUROC 0.805 (SAS), multi-ancestry. Tanha HM et al., HGG Adv 2025. (Multi (SBayesRC))",
...
_t("pgs_prostate_67", "PGS - Cancer", "Prostate cancer (hazard) (PGS000067)",
   "54 variants. HR 2.9 (top 2%). Seibert TM et al., BMJ 2018. (EUR (31.7K))",
   "pgs_score", {"pgs_id": "PGS000067", "trait": "Prostate cancer"})
_t("pgs_prostate_663", "PGS - Cancer", "Prostate cancer (aggressive) (PGS000663)",
   "269 variants. OR 5.54 (top vs bottom decile). Conti DV et al., Nat Genet 2021. (Multi)",
   "pgs_score", {"pgs_id": "PGS000663", "trait": "Prostate cancer"})
_t("pgs_colorectal_3852", "PGS - Cancer", "Colorectal cancer (PGS003852)",
   "1,000,000 variants. OR 1.67, multi-ancestry. Thomas M et al., Nat Commun 2023. (Multi (255K))",
...
_t("pgs_colorectal_4580", "PGS - Cancer", "Colorectal cancer (genome-wide) (PGS004580)",
   "1,099,906 variants. OR 1.50/SD. Youssef O et al., Lab Invest 2024. (EUR (93K))",
...
_t("pgs_lung_82", "PGS - Cancer", "Lung cancer (squamous) (PGS000082)",
   "109 variants. AUROC 0.74. Graff RE et al., Nat Commun 2021. (EUR)",
   "pgs_score", {"pgs_id": "PGS000082", "trait": "Lung cancer"})
_t("pgs_lung_81", "PGS - Cancer", "Lung cancer (adenocarcinoma) (PGS000081)",
   "109 variants. AUROC 0.80. Graff RE et al., Nat Commun 2021. (EUR)",
   "pgs_score", {"pgs_id": "PGS000081", "trait": "Lung cancer"})
...
_t("pgs_ovarian_49", "PGS - Cancer", "Ovarian cancer (serous) (PGS000049)",
   "30 variants. OR 1.55. Phelan CM et al., Nat Genet 2017. (EUR)",
   "pgs_score", {"pgs_id": "PGS000049", "trait": "Ovarian cancer"})
...
_t("pgs_squamous_4592", "PGS - Cancer", "Squamous cell carcinoma (PGS004592)",
   "78 variants. AUROC 0.74 (keratinocyte). Liyanage UE et al., J Eur Acad Dermatol 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS004592", "trait": "Squamous cell carcinoma"})
_t("pgs_squamous_72", "PGS - Cancer", "Squamous cell carcinoma (PGS000072)",
   "15 variants. AUROC 0.77. Graff RE et al., Nat Commun 2021. (EUR)",
   "pgs_score", {"pgs_id": "PGS000072", "trait": "Squamous cell carcinoma"})
...
_t("pgs_nonhodgkin_75", "PGS - Cancer", "Non-Hodgkin lymphoma (PGS000075)",
   "15 variants. AUROC 0.73. Graff RE et al., Nat Commun 2021. (EUR)",
   "pgs_score", {"pgs_id": "PGS000075", "trait": "Non-Hodgkin lymphoma"})
...
_t("pgs_cll_76", "PGS - Cancer", "CLL (PGS000076)",
   "15 variants. AUROC 0.83. Graff RE et al., Nat Commun 2021. (EUR)",
   "pgs_score", {"pgs_id": "PGS000076", "trait": "CLL"})
...
_t("pgs_multiple_74", "PGS - Cancer", "Multiple myeloma (PGS000074)",
   "15 variants. AUROC 0.72. Graff RE et al., Nat Commun 2021. (EUR)",
   "pgs_score", {"pgs_id": "PGS000074", "trait": "Multiple myeloma"})
...
_t("pgs_esophageal_70", "PGS - Cancer", "Esophageal cancer (PGS000070)",
   "15 variants. AUROC 0.71. Graff RE et al., Nat Commun 2021. (EUR)",
   "pgs_score", {"pgs_id": "PGS000070", "trait": "Esophageal cancer"})
...
_t("pgs_cervical_1286", "PGS - Cancer", "Cervical cancer (PGS001286)",
   "73 variants. AUROC 0.58. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001286", "trait": "Cervical cancer"})
_t("pgs_hepatocellular_872", "PGS - Cancer", "Hepatocellular carcinoma (PGS000872)",
   "5 variants. OR 3.4-11.9 (NAFLD/cirrhosis). Bianco C et al., J Hepatol 2020. (EUR)",
   "pgs_score", {"pgs_id": "PGS000872", "trait": "Hepatocellular carcinoma"})
_t("pgs_hepatocellular_2254", "PGS - Cancer", "Hepatocellular carcinoma (PGS002254)",
   "8 variants. HR 1.33. Sarin SK et al., Hepatology 2022. (Multi)",
   "pgs_score", {"pgs_id": "PGS002254", "trait": "Hepatocellular carcinoma"})
...
_t("pgs_coronary_18", "PGS - Cardiovascular", "Coronary artery disease (CAD) (metaGRS) (PGS000018)",
   "1,745,179 variants. AUROC 0.79, HR 1.71/SD. Inouye M et al., JACC 2018. (EUR (382K))",
...
_t("pgs_coronary_13", "PGS - Cardiovascular", "Coronary artery disease (CAD) (GPS) (PGS000013)",
   "6,630,150 variants. AUROC 0.81. Khera AV et al., Nat Genet 2018. (EUR (120K))",
   "pgs_score", {"pgs_id": "PGS000013", "trait": "Coronary artery disease (CAD)"})
_t("pgs_coronary_2297", "PGS - Cardiovascular", "Coronary artery disease (CAD) (LDpred2) (PGS002297)",
   "1,259,754 variants. AUROC 0.78. Ge T et al., Genome Med 2022. (Multi)",
   "pgs_score", {"pgs_id": "PGS002297", "trait": "Coronary artery disease (CAD)"})
...
_t("pgs_atrial_3724", "PGS - Cardiovascular", "Atrial fibrillation (multi-ancestry) (PGS003724)",
   "1,296,172 variants. HR 1.60. Patel AP et al., Nat Med 2023. (Multi)",
   "pgs_score", {"pgs_id": "PGS003724", "trait": "Atrial fibrillation"})
...
_t("pgs_heart_1236", "PGS - Cardiovascular", "Heart failure (dilated CM) (PGS001236)",
   "1,138 variants. AUROC 0.61. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001236", "trait": "Heart failure"})
...
_t("pgs_stroke_4835", "PGS - Cardiovascular", "Stroke (PRSmix) (PGS004835)",
   "2,263,784 variants. Incr. R2=0.007. Truong B et al., Cell Genomics 2024. (EUR)",
   "pgs_score", {"pgs_id": "PGS004835", "trait": "Stroke"})
...
_t("pgs_vte_3332", "PGS - Cardiovascular", "VTE (venous thromboembolism) (genome-wide) (PGS003332)",
   "1,092,045 variants. OR 1.51/SD, AUROC 0.68. Ghouse J et al., Nat Genet 2023. (EUR (1.06M))",
...
_t("pgs_aortic_1285", "PGS - Cardiovascular", "Aortic stenosis (PGS001285)",
   "11,285 variants. AUROC 0.63. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001285", "trait": "Aortic stenosis"})
...
_t("pgs_systolic_2611", "PGS - Cardiovascular", "Systolic BP (PGS002611)",
   "1,103,034 variants. R2=0.108. Weissbrod O et al., Nat Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002611", "trait": "Systolic BP"})
_t("pgs_diastolic_2610", "PGS - Cardiovascular", "Diastolic BP (PGS002610)",
   "1,103,034 variants. R2=0.080. Weissbrod O et al., Nat Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002610", "trait": "Diastolic BP"})
_t("pgs_hypertrophic_1284", "PGS - Cardiovascular", "Hypertrophic CM (PGS001284)",
   "4,236 variants. AUROC 0.61. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001284", "trait": "Hypertrophic CM"})
_t("pgs_resting_2603", "PGS - Cardiovascular", "Resting heart rate (PGS002603)",
   "1,060,971 variants. R2=0.041. Weissbrod O et al., Nat Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002603", "trait": "Resting heart rate"})
...
_t("pgs_telomere_2616", "PGS - Lifestyle", "Telomere length (PGS002616)",
   "1,103,034 variants. R2=0.024. Weissbrod O et al., Nat Genet 2022",
   "pgs_score", {"pgs_id": "PGS002616", "trait": "Telomere length"})
_t("pgs_myopia_1204", "PGS - Lifestyle", "Myopia (PGS001204)",
   "25,543 variants. R2=0.06. Tanigawa Y et al., PLoS Genet 2022",
   "pgs_score", {"pgs_id": "PGS001204", "trait": "Myopia"})
...
_t("pgs_gallstones_1291", "PGS - Lifestyle", "Gallstones (PGS001291)",
   "5,387 variants. AUROC 0.63. Tanigawa Y et al., PLoS Genet 2022",
   "pgs_score", {"pgs_id": "PGS001291", "trait": "Gallstones"})
_t("pgs_osteoarthritis_1296", "PGS - Lifestyle", "Osteoarthritis (knee) (PGS001296)",
   "6,234 variants. AUROC 0.58. Tanigawa Y et al., PLoS Genet 2022",
   "pgs_score", {"pgs_id": "PGS001296", "trait": "Osteoarthritis (knee)"})
...
_t("pgs_type_3103", "PGS - Metabolic", "Type 2 diabetes (ExPRSweb) (PGS003103)",
   "945,820 variants. AUROC 0.725 (EUR). ExPRSweb consortium. (EUR)",
   "pgs_score", {"pgs_id": "PGS003103", "trait": "Type 2 diabetes"})
_t("pgs_type_14", "PGS - Metabolic", "Type 2 diabetes (classic GPS) (PGS000014)",
   "6,917,436 variants. AUROC 0.73. Khera AV et al., Nat Genet 2018. (EUR (120K))",
   "pgs_score", {"pgs_id": "PGS000014", "trait": "Type 2 diabetes"})
_t("pgs_type_2771", "PGS - Metabolic", "Type 2 diabetes (beta-cell) (PGS002771)",
   "varies variants. Cluster-specific risk. Udler MS et al., PLoS Med 2018. (EUR)",
   "pgs_score", {"pgs_id": "PGS002771", "trait": "Type 2 diabetes"})
_t("pgs_type_339", "PGS - Metabolic", "Type 1 diabetes (GRS2) (PGS000339)",
   "67 variants. AUROC 0.92 (T1D vs T2D). Sharp SA et al., Diabetes Care 2019. (EUR)",
   "pgs_score", {"pgs_id": "PGS000339", "trait": "Type 1 diabetes"})
...
_t("pgs_bmi_5198", "PGS - Metabolic", "BMI / Obesity (GIANT 2025) (PGS005198)",
   "1,217,710 variants. R2=0.176 (EUR), OR 4.08 top 3%. Smit RAJ et al., Nat Med 2025. (Multi (5.1M))",
...
_t("pgs_bmi_5235", "PGS - Metabolic", "BMI / Obesity (obesity) (PGS005235)",
   "709,828 variants. OR 1.97/SD (obesity). Arehart CH et al., Nat Commun 2025. (EUR)",
   "pgs_score", {"pgs_id": "PGS005235", "trait": "BMI / Obesity"})
_t("pgs_bmi_2303", "PGS - Metabolic", "BMI / Obesity (multi-ancestry) (PGS002303)",
   "1,259,754 variants. R2=0.09. Ge T et al., Genome Med 2022. (Multi)",
   "pgs_score", {"pgs_id": "PGS002303", "trait": "BMI / Obesity"})
_t("pgs_ldl_2609", "PGS - Metabolic", "LDL Cholesterol (PGS002609)",
   "1,103,034 variants. R2=0.172. Weissbrod O et al., Nat Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002609", "trait": "LDL Cholesterol"})
...
_t("pgs_total_2608", "PGS - Metabolic", "Total Cholesterol (PGS002608)",
   "1,103,034 variants. R2=0.155. Weissbrod O et al., Nat Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002608", "trait": "Total Cholesterol"})
...
_t("pgs_triglycerides_2607", "PGS - Metabolic", "Triglycerides (PGS002607)",
   "1,103,034 variants. R2=0.115. Weissbrod O et al., Nat Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002607", "trait": "Triglycerides"})
...
_t("pgs_egfr_2605", "PGS - Metabolic", "eGFR / kidney function (PGS002605)",
   "1,103,034 variants. R2=0.048. Weissbrod O et al., Nat Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002605", "trait": "eGFR / kidney function"})
_t("pgs_vitamin_1907", "PGS - Metabolic", "Vitamin D levels (PGS001907)",
   "8,505 variants. R2=0.035. Prive F et al., AJHG 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001907", "trait": "Vitamin D levels"})
...
_t("pgs_parkinsons_4924", "PGS - Neurological", "Parkinson's disease (PGS004924)",
   "90 variants. OR 3.79 (top vs bottom quartile). Cao Z et al., Parkinsonism Relat Disord 2023. (EUR)",
   "pgs_score", {"pgs_id": "PGS004924", "trait": "Parkinson's disease"})
_t("pgs_parkinsons_902", "PGS - Neurological", "Parkinson's disease (multi-ancestry) (PGS000902)",
   "90 variants. AUROC 0.651, OR 1.575/SD. Nalls MA et al., Lancet Neurol 2019. (Multi)",
   "pgs_score", {"pgs_id": "PGS000902", "trait": "Parkinson's disease"})
...
_t("pgs_schizophrenia_2785", "PGS - Neurological", "Schizophrenia (SDPR) (PGS002785)",
   "964,422 variants. R2=0.008. Gui Y et al., Transl Psychiatry 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002785", "trait": "Schizophrenia"})
_t("pgs_schizophrenia_3472", "PGS - Neurological", "Schizophrenia (PGC3) (PGS003472)",
   "varies variants. AUROC 0.76. Trubetskoy V et al., Nature 2022. (Multi (320K))",
   "pgs_score", {"pgs_id": "PGS003472", "trait": "Schizophrenia"})
...
_t("pgs_major_2759", "PGS - Neurological", "Major depression (PRS-CS) (PGS002759)",
   "1,091,613 variants. OR 1.26/SD. Mars N et al., AJHG 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002759", "trait": "Major depression"})
_t("pgs_bipolar_2788", "PGS - Neurological", "Bipolar II (PGS002788)",
   "935,292 variants. R2=0.003. Gui Y et al., Transl Psychiatry 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002788", "trait": "Bipolar II"})
...
_t("pgs_anorexia_379", "PGS - Neurological", "Anorexia nervosa (PGS000379)",
   "66,177 variants. OR 1.24/SD. Watson HJ et al., Nat Genet 2019. (EUR)",
   "pgs_score", {"pgs_id": "PGS000379", "trait": "Anorexia nervosa"})
...
_t("pgs_height_2596", "PGS - Traits", "Height (genome-wide) (PGS002596)",
   "1,103,034 variants. R2=0.654. Weissbrod O et al., Nat Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002596", "trait": "Height"})
_t("pgs_height_5006", "PGS - Traits", "Height (multi-ancestry) (PGS005006)",
   "1,273,897 variants. R2=0.159 (EUR), 0.051 (AFR). Gunn S et al., HGG Adv 2024. (Multi)",
   "pgs_score", {"pgs_id": "PGS005006", "trait": "Height"})
_t("pgs_height_2305", "PGS - Traits", "Height (multi-ancestry) (PGS002305)",
   "1,259,754 variants. R2=0.61. Ge T et al., Genome Med 2022. (Multi)",
   "pgs_score", {"pgs_id": "PGS002305", "trait": "Height"})
...
_t("pgs_intelligence_2135", "PGS - Traits", "Intelligence / Cognitive Ability (fluid intelligence) (PGS002135)",
   "903,000 variants. R2=0.10. Prive F et al., AJHG 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002135", "trait": "Intelligence / Cognitive Ability"})
_t("pgs_intelligence_1919", "PGS - Traits", "Intelligence / Cognitive Ability (fluid intelligence) (PGS001919)",
   "26,000 variants. R2=0.06. Prive F et al., AJHG 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001919", "trait": "Intelligence / Cognitive Ability"})
_t("pgs_intelligence_1232", "PGS - Traits", "Intelligence / Cognitive Ability (fluid intelligence) (PGS001232)",
   "10,000 variants. R2=0.04. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001232", "trait": "Intelligence / Cognitive Ability"})
_t("pgs_intelligence_1550", "PGS - Traits", "Intelligence / Cognitive Ability (working memory) (PGS001550)",
   "varies variants. R2=0.02. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001550", "trait": "Intelligence / Cognitive Ability"})
_t("pgs_intelligence_1923", "PGS - Traits", "Intelligence / Cognitive Ability (reaction time) (PGS001923)",
   "varies variants. R2=0.01. Prive F et al., AJHG 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001923", "trait": "Intelligence / Cognitive Ability"})
_t("pgs_intelligence_1541", "PGS - Traits", "Intelligence / Cognitive Ability (brain volume) (PGS001541)",
   "varies variants. R2=0.05. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001541", "trait": "Intelligence / Cognitive Ability"})
_t("pgs_educational_3390", "PGS - Traits", "Educational Attainment & Socioeconomic Proxies (EA4, latest) (PGS003390)",
   "varies variants. r=0.19 (EUR). Okbay A et al., Nat Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS003390", "trait": "Educational Attainment & Socioeconomic Proxies"})
_t("pgs_educational_2319", "PGS - Traits", "Educational Attainment & Socioeconomic Proxies (college, multi eval) (PGS002319)",
   "1,109,311 variants. Incr. R2=0.055 (EUR), 0.022 (SAS). Weissbrod O et al., Nat Genet 2022. (Multi)",
   "pgs_score", {"pgs_id": "PGS002319", "trait": "Educational Attainment & Socioeconomic Proxies"})
_t("pgs_educational_2231", "PGS - Traits", "Educational Attainment & Socioeconomic Proxies (years of schooling) (PGS002231)",
   "varies variants. r=0.17. Prive F et al., AJHG 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002231", "trait": "Educational Attainment & Socioeconomic Proxies"})
_t("pgs_educational_2235", "PGS - Traits", "Educational Attainment & Socioeconomic Proxies (household income) (PGS002235)",
   "varies variants. R2=0.03. Prive F et al., AJHG 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002235", "trait": "Educational Attainment & Socioeconomic Proxies"})
_t("pgs_educational_2232", "PGS - Traits", "Educational Attainment & Socioeconomic Proxies (occupational status) (PGS002232)",
   "varies variants. R2=0.02. Prive F et al., AJHG 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS002232", "trait": "Educational Attainment & Socioeconomic Proxies"})
_t("pgs_educational_1712", "PGS - Traits", "Educational Attainment & Socioeconomic Proxies (highest math class) (PGS001712)",
   "varies variants. R2=0.02. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS001712", "trait": "Educational Attainment & Socioeconomic Proxies"})
_t("pgs_educational_947", "PGS - Traits", "Educational Attainment & Socioeconomic Proxies (reading/literacy) (PGS000947)",
   "varies variants. R2=0.03. Tanigawa Y et al., PLoS Genet 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS000947", "trait": "Educational Attainment & Socioeconomic Proxies"})
_t("pgs_educational_3306", "PGS - Traits", "Educational Attainment & Socioeconomic Proxies (openness to experience) (PGS003306)",
   "varies variants. R2=0.02. Ding Y et al., bioRxiv 2022. (EUR)",
   "pgs_score", {"pgs_id": "PGS003306", "trait": "Educational Attainment & Socioeconomic Proxies"})
...
_t("pgs_handedness_2151", "PGS - Traits", "Handedness (left) (PGS002151)",
   "734,236 variants. partial-r=0.025-0.042. Prive F et al., AJHG 2022",
   "pgs_score", {"pgs_id": "PGS002151", "trait": "Handedness (left)"})
...
_t("pgs_pgs_2309", "PGS - Traits", "# Children born (PGS002309)",
   "1,109,311 variants. Incr. R2=0.008. Weissbrod O et al., Nat Genet 2022",
   "pgs_score", {"pgs_id": "PGS002309", "trait": "# Children born"})
_t("pgs_grip_1162", "PGS - Traits", "Grip strength (PGS001162)",
   "10,872 variants. R2=0.033. Tanigawa Y et al., PLoS Genet 2022",
   "pgs_score", {"pgs_id": "PGS001162", "trait": "Grip strength"})
...
_t("pgs_voice_1197", "PGS - Traits", "Voice pitch (PGS001197)",
   "4,621 variants. R2=0.015. Tanigawa Y et al., PLoS Genet 2022",
   "pgs_score", {"pgs_id": "PGS001197", "trait": "Voice pitch"})
...
_t("carrier_cf", "Carrier Status", "Cystic fibrosis (CFTR)",
   ...
   "variant_lookup", {"variants": [{"rs": "rs113993960", "gene": "CFTR", "name": "F508del"}], "disease": "Cystic fibrosis"})
...
_t("carrier_taysachs", "Carrier Status", "Tay-Sachs (HEXA)",
   ...
   "variant_lookup", {"variants": [{"rs": "rs387906309", "gene": "HEXA", "name": "1278insTATC"}], "disease": "Tay-Sachs"})
...
_t("carrier_pompe", "Carrier Status", "Pompe disease (GAA)",
   ...
   "variant_lookup", {"variants": [{"rs": "rs386834236", "gene": "GAA", "name": "c.-32-13T>G"}], "disease": "Pompe disease"})

# ── 10. Single-Variant Health Risk ───────────────────────────────
_t("var_apoe", "Single Variants", "APOE e4 (Alzheimer's)",
   "rs429358 + rs7412. e4/e4 = 12-15x AD risk. e4 freq: 14%",
   "variant_lookup", {"variants": [
       {"rs": "rs429358", "gene": "APOE", "name": "APOE-C112R"},
       {"rs": "rs7412", "gene": "APOE", "name": "APOE-R158C"}
   ], "disease": "Alzheimer's risk (APOE)", "interpretation": "apoe"})
...
_t("pgx_cyp2d6", "Pharmacogenomics", "CYP2D6",
   "Star alleles *3, *4, *10, *17, *41 + CNV. Drugs: codeine, tamoxifen, SSRIs. CPIC Level A",
   "specialized", {"method": "pgx", "gene": "CYP2D6"})

_t("pgx_cyp2c19", "Pharmacogenomics", "CYP2C19",
   "*2 (rs4244285), *3, *17. Drugs: clopidogrel, PPIs, SSRIs. CPIC Level A",
   "variant_lookup", {"variants": [
...
_t("pgx_cyp2c9", "Pharmacogenomics", "CYP2C9",
   "*2 (rs1799853), *3 (rs1057910). Drugs: warfarin, NSAIDs. CPIC Level A",
   "variant_lookup", {"variants": [
...
_t("pgx_dpyd", "Pharmacogenomics", "DPYD",
   "*2A (rs3918290). Drugs: 5-FU, capecitabine (PM = fatal!). CPIC Level A",
   "variant_lookup", {"variants": [{"rs": "rs3918290", "gene": "DPYD", "name": "*2A"}], "disease": "DPYD deficiency (5-FU toxicity)"})

_t("pgx_tpmt", "Pharmacogenomics", "TPMT",
   "*3A/*3C. Drugs: azathioprine, 6-MP. CPIC Level A",
   "variant_lookup", {"variants": [
       {"rs": "rs1800460", "gene": "TPMT", "name": "*3A-A"},
       {"rs": "rs1142345", "gene": "TPMT", "name": "*3C"}
   ], "disease": "TPMT metabolizer status"})

_t("pgx_slco1b1", "Pharmacogenomics", "SLCO1B1",
   "*5 (rs4149056). Drugs: statins. CPIC Level A",
   "variant_lookup", {"variants": [{"rs": "rs4149056", "gene": "SLCO1B1", "name": "*5"}], "disease": "Statin myopathy risk"})

_t("pgx_comt", "Pharmacogenomics", "COMT",
   "Val158Met (rs4680). Pain meds. CPIC Level B",
...
# Small-panel published polygenic scores using hand-curated rsID lists with
# effect sizes and risk alleles. Each trait is a separate runnable test.
try:
...
for _idx, _pgs in enumerate(_RSID_PGS_LIST):
    ...
    # Disambiguate if two tests share the same (title, first-author) slug.
    _base = _id
    _suffix = 2
